...
Selecciona todos los conductores Gammavet para el batch fijo diario de confirmacion de disponibilidad.
...
- **Timeout**: 120s
- **Memory**: 256MB
- **Layers**: foundationMinimal, foundationApi
...
- **now_iso** (string): Fecha/hora ISO opcional para pruebas.
- **test_drivers_json** (string): Lista JSON opcional de conductores para pruebas.
...
- The function name matches "GammavetDispatchAvailabilityConfirmFn"
...
- AWS CloudWatch Logs: `/aws/lambda/GammavetDispatchAvailabilityConfirmFn`
- Chask dashboard: Organization → Functions → GammavetDispatchAvailabilityConfirmFn
